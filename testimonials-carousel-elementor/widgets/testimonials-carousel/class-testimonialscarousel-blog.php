                ...
                <?php if (wp_kses($item['slide_show_button'], []) === 'yes') { ?>
                  <div class="slide-coverflow-button-wrapper">
                    <a id="<?php echo wp_kses($item['slide_button_css_id'], []); ?>"
                       class="elementor-button read-more-btn blog-slider__button <?php if (!empty($settings['slide_button_hover_animation'])) { ?> elementor-animation-<?php echo esc_attr($settings['slide_button_hover_animation']);
                       } ?>"
                      <?php if (wp_kses($item['slide_show_button_link'], []) === 'yes' && $settings['slider_global_show_button_link'] === 'yes') {
                       ...
                       data-text="<?php echo wp_kses($item['slide_button'], []); ?>">
